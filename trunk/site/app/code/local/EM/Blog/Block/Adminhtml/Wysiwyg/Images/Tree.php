 ...
 */
class EM_Blog_Block_Adminhtml_Wysiwyg_Images_Tree extends Mage_Adminhtml_Block_Template
{
    ...
    {
        $helper = Mage::helper('blog/wysiwyg_images');
    ...
    {
        return $this->helper('blog')->__('Storage Root');
    }
