<?php
class EM_Blog_Block_Category extends Mage_Core_Block_Template
{
    public function _initCategory()
    {
        if(!Mage::registry('current_cat') || $id = $this->getRequest()->getParam('id'))
        {
            $id = Mage::app()->getFrontController()->getRequest()->getParam('cat');
