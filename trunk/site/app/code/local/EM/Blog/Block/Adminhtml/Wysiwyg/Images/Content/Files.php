 ...
 */
class EM_Blog_Block_Adminhtml_Wysiwyg_Images_Content_Files extends Mage_Adminhtml_Block_Template
{
    /**
    ...
    public function getFiles()
    {
        if (! $this->_filesCollection) {
            $this->_filesCollection = Mage::getSingleton('blog/wysiwyg_images_storage')->getFilesCollection(Mage::helper('blog/wysiwyg_images')->getCurrentPath(), $this->_getMediaType());
    ...
    {
        return Mage::getSingleton('blog/wysiwyg_images_storage')->getConfigData('resize_width');
    }

    public function getImagesHeight()
    {
        return Mage::getSingleton('blog/wysiwyg_images_storage')->getConfigData('resize_height');
    }
