  ...
  protected function _prepareForm()
  {
      ...
      if ( Mage::getSingleton('adminhtml/session')->getPostData() )
      {
          ...
          if(isset($data['tags']))
          {
                ...
                {
                    $tagListHtml    .= "<li style='cursor:pointer' onclick='removeTag(".$i.");' id='".$i."'>".$t['name']."</li>";
                    $tagValueHtml   .= "<input id='".$i."value' type='hidden' name='tags[]' value='".$t['id']."'/>";
                    $tagNameHtml    .= "<input id='".$i."name' type='hidden' name='tags_name[]' value='".$t['name']."'/>";
                    $i++;
                }
          }
      }
